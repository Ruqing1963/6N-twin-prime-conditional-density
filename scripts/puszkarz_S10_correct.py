# Puszkarz recovery test on S10 (10^9..10^10), using the verified complete-factorisation + interval-sieve logic.
# Re-sieve twins from scratch, with no reliance on an external 'centre list'. Outputs (a) unweighted ratio (b) E-weighted ratio (c) observed twin ratio.
import numpy as np, math, time
LO = 10**9 // 6 + 1      # lower N bound so that 6N >= 10^9
HI = 10**10 // 6          # upper N bound so that 6N < 10^10
SEG = 3_000_000
...
while n<=HI:
    ...
    # observed twins: interval sieve on 6N±1
